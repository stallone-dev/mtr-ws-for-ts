...
import { listarClassesMethod } from "~service/consult/listar_unidades_medida/listar_unidades_medida.service.ts";
    ...
    it("> Basic request", async () => {
        ...
        expect(result).toEqual(
            expect.arrayContaining([
                expect.objectContaining({ uniCodigo: 2, uniDescricao: "Quilograma", uniSigla: "KG" }),
            ]),
        );
